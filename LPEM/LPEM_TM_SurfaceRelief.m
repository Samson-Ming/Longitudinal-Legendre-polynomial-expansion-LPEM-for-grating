...
d=0.5;      % Grating thickness (Normalized to the grating period)
eps1=1;     %Permittivity of incident medium
eps3=3^2;     %Permittivity of transmission medium
...
% surfaces.
[xt,epst]=trapezoidalsurface15(0.2,0.4,0.6,0.8,eps1,eps3,d,L*nlayer);
