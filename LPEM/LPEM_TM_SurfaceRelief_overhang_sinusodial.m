...
N_l    =40;           % lower number of layers,40
...
%filename = 'Metal_overhang_relief_sinusodial_0.5h_Phi=60_TM_1percent_LPEM.mat';
filename = 'Metal_overhang_relief_sinusodial_0.5h_Phi=60_TM_1percent_LPEM_N=41_L=40_3_1.mat';
save(filename)       
