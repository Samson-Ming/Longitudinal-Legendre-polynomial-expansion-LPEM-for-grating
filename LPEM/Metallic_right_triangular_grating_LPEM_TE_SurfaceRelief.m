...
RS_ref=[0.266477888803202,0.247755429397570,0.141235922156067];
TS_ref=[];
...
[xt,epst]=trapezoidalsurface15(0,1,1,1,eps1,eps3,d,L*nlayer);
...
%filename = 'metallic_right_triangular_relief_trapezoid_TE_1percent_LPEM.mat';
filename = 'metallic_right_triangular_relief_trapezoid_TE_1percent_LPEM_N=101_L=20.mat';
save(filename)  
