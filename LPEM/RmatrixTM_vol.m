function [r11 r12 r21 r22]=RmatrixTM_vol(epsx,d,lambda,alpha,eps1,N,M)
 
% This function calculates R matrix of a volume grating for TM polarization.
% 
...
% ----------------------------------------------------
eps=fastft(epsx/i,2*N).';
Ieps=fastft(-i./epsx,2*N).';
